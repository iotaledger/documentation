...
**In the Channels app, messages can be one of seven types, and each message contains [Protobuf3](root://iota-streams/0.1/introduction/core-concepts.md#protobuf3-messaging) content that is specific to its type. This article describes what each message type is for and what fields it contains.**
